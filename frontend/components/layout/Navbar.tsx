          ...
          {user && (
            <>
              <div className="flex items-center space-x-3 bg-surface-container px-4 py-2 rounded-xl border border-outline-variant">
                <div className="w-10 h-10 rounded-full bg-primary-container flex items-center justify-center shadow-md border-2 border-white">
              ...
              <Button
                ...
                className="font-semibold border border-white text-white hover:bg-red-500/10"
              >
